                    ...
                    filteredTemplates.map((template) => (
                      <div
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02] 
                            ${selectedTemplate === template.id ? "border-[#E93F3F] shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)]" : "hover:border-[#E93F3F] shadow-[0_2px_10px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(233,63,63,0.1)]"}  `}
